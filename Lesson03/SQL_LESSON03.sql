...
USE master
GO
CREATE DATABASE DEV2311LM_SQL24_03_DATA
ON
(NAME = DEV2311LM_SQL24_03_DATA,
    FILENAME = 'D:\00.DATABASE\DEV2311LM_SQL24_03.mdf',
    SIZE = 10,
    MAXSIZE = 50,
    FILEGROWTH = 5
)
...
(NAME = DEV2311LM_SQL24_03_log,
    FILENAME = 'D:\00.DATABASE\DEV2311LM_SQL24_03_log.ldf',
    SIZE = 5MB,
    MAXSIZE = unlimited,
    FILEGROWTH = 5MB
);
...
-- BỔ SUNG KHÁO NGOẠI (MANHACC) THAM CHIẾU ĐẾN BẢNG NHÀ CC
--FK(MANHACC)- NHACC
...
--3.3 update -> sửa đỏi dữ liệu trên cột trong bảng
-- xoá cũ, thêm mới/
--Syntax
/*
